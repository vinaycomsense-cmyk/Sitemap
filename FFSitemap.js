    ...
    const sitemapConfig = {
        ...
        pageTypes: [

            {
                ...
                isMatch: () => {
                    return /\/in\/en\/product\/(c6|s6)\//.test(
            ...
            //check
            {
                ...
                isMatch: () => {
                    return currentHost === "flyingflea.royalenfield.com" &&
            ...
            //up
            {
                ...
                isMatch: () => {
                    return currentHost === "booking.flyingflea.com" &&
                    ...
                    SalesforceInteractions.listener(
                        ...
                        () => {
                            ...
                            if (buttonText === "Continue") {
                                ...
                                const city =
                                    SalesforceInteractions.cashDom(
                                        "input[name='city-display']"
                                    ).val()?.trim() || "";

                                const state =
                                    SalesforceInteractions.cashDom(
                                        "input[name='state-display']"
                                    ).val()?.trim() || "";
